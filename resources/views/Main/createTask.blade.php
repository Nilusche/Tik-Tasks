        ...
        <form  class="form_a_e"  action="/Save-tasks" method="POST">
            ...
            <div class="teil_a_e">
                <div class="neuer_abschnitt">
                    ...
                    <input class="input_a_e  @error('title') is-invalid @enderror" type="text"  id="title" name="title"  value="{{old('title')}}"placeholder="Titel der Aufgabe">
                    @error('title')
                    ...
                    <input class="input_a_e  @error('deadline') is-invalid @enderror" type="datetime-local" id="deadline" name="deadline" value="{{old('deadline')}}">
                    @error('deadline')
                        <span class="invalid-feedback" role="alert">
                            <strong class="danger">{{ $message }}</strong>
                        </span>
                    ...
                    <textarea class="inputtext_a_e  @error('description') is-invalid @enderror"  class="form-control" name="description" placeholder="Beschreibung" id="description" cols="50" rows="9">{{old('description')}}</textarea>
                    @error('description')
                        <span class="invalid-feedback" role="alert">
                            <strong class="danger">{{ $message }}</strong>
                        </span>
                    ...
                    <input class="input_a_e @error('comment') is-invalid @enderror" type="text"  id="comment" name="comment" value="{{old('comment')}}" placeholder="Kommentar">
                    @error('comment')
                        <span class="invalid-feedback" role="alert">
                            <strong class="danger">{{ $message }}</strong>
                        </span>
                    ...
                    <input class="input_a_e @error('effort') is-invalid @enderror" type="number" id="effort" name="effort" min="0" value="{{old('effort')}}" placeholder="3.5">
                    @error('effort')
                        <span class="invalid-feedback" role="alert">
                            <strong class="danger">{{ $message }}</strong>
                        </span>
