        ...
        @foreach ($tasks as $task)
            ...
            <div class="container" data-aos="zoom-in-down">
                    <div class="blog-card">
                            ...
                            <p class="read-more">                   
                                <a  type="button" data-toggle="collapse" id="open" data-target="#collapseExample{{$task->tasks_id}}" aria-expanded="false" aria-controls="collapseExample{{$task->tasks_id}}">Mehr anzeigen</a>
                            </p>
                            ...
                            <div class="collapse" id="collapseExample{{$task->tasks_id}}">
                                ...
                                <div class="mt-4">
                                        <b class="mr-4">
                                            <button  class="btn btn-warning but " href="" data-bs-toggle="modal" data-bs-target="#finish{{ $task->tasks_id }}"><i class="fas fa-check-circle"></i>Beenden</button>
                                        </b>
                                        &nbsp;&nbsp;&nbsp;
                                        <b>
                                            <button class="btn btn-danger but" href="" data-bs-toggle="modal" data-bs-target="#deleteTask{{ $task->tasks_id}}"><i class="fas fa-trash-alt"></i>Löschen</button>
                                        </b>
                                </div>
                                <p class="read-more">
