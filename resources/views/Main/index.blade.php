    ...
    <div class="container-fluid navcontainer">
        <nav class="navbar navbar-expand-lg navbar-dark back">
            <a class="navbar-brand" href="/Startseite">
                <img class="TikTaskPicture" src="sources/TikTasks.png" alt="TikTasksPicture" width="150" height="150">
            </a>
                    ...
                    <div class="col-sm">
                        <div class="form-group">
                            <a class="btn btn-danger" type="button" data-bs-toggle="modal"
                                data-bs-target="#deleteGroup{{ $task->tag_id }}"><i class="fas fa-trash-alt">
                                    Löschen</i></a>
                        </div>
                    </div>
                </div>
